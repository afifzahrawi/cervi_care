                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: 'Enter patient\'s I/C number',
                                        enabledBorder: OutlineInputBorder(
                                          borderSide: BorderSide(
                                            color: FlutterFlowTheme.of(context)
                                                .secondary,
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                  fit: BoxFit.cover,
                                                  image: Image.asset(
                                                    'assets/images/upload_image_placeholder.png',
                                                  ).image,
                                                ),
                                              ),
                                            ),
                                  ...
                                  Container(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => SizedBox(
                                        key: const ValueKey('TFModel'),
                                        width: 200.0,
                                        child: custom_widgets.ImageRecognition(
                                          width: 200.0,
                                          imageUrl: currentUserPhoto,
                                          onLabelRecognized: (label) {
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          100.0, 15.0, 100.0, 30.0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          await ImagesRecord.collection.doc().set({
                            ...createImagesRecordData(
                              image: currentUserPhoto,
                              recordName: _model.fullNameTextController1.text,
                              recordIC: _model.fullNameTextController2.text,
                              comment: _model.fullNameTextController4.text,
                              userLink: currentUserReference,
                              result: _model.fullNameTextController3.text,
                              hospitalName: valueOrDefault(
                                  currentUserDocument?.hospitalName, ''),
                              userFullname: valueOrDefault(
